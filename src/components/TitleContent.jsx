...
function TitleContent(props){
    return(
        ...
        : <div><h1>FINE ART RESTORATION AND MOUNTING</h1><h3>Tai Gu Zai provides industry-leading designing and crafting services for custom artworks of all lengths and styles. And we are excellent at appreciating pepsis.</h3></div>
        }            
            <CarouselGallery />
